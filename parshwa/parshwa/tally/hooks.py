...
from parshwa.parshwa.tally.journal_entry import (
    create_tally_journal_entry,
    cancel_tally_journal_entry,
    delete_tally_journal_entry,
)

from parshwa.parshwa.tally.sales_invoice import (
...
def on_purchase_invoice_submit(doc, method=None):
    ...
    from parshwa.parshwa.tally.purchase_invoice import (
...
def on_payment_entry_submit(doc, method=None):
    ...
    from parshwa.parshwa.tally.payment_entry import (
